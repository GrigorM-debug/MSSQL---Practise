ALTER PROCEDURE usp_PlaceOrder @CustomerID INT, @ParBookType BookType READONLY, @Quantity INT
AS
BEGIN
	BEGIN TRY
		...
		DECLARE @IsCustomerExisting BIT = (SELECT dbo.fn_CustomerExistingByCustomerID(@CustomerID))
